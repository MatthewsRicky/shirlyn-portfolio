...
export default function Project({
  ...
  return (
    ...
    >
      <section className="bg-slate-100 hover:bg-slate-200 max-w-2xl border border-black/5 overflow-hidden sm:pr-8 sm:h-fit w-fit rounded-lg relative sm:group-even:pl-8 transition mb-28 dark:bg-slate-50/20 dark:hover:bg-slate-50/30 dark:text-slate-50">
